...
export default function IncomeContent() {
  ...
  return (
    <Table>
      <TableCaption>A list of your recent Income Transactions.</TableCaption>
      <TableHeader>
        ...
        {transaction?.map((item) => (
          <TableRow key={item._id}>
            ...
            <TableCell className="flex items-center gap-2">
              <EditTransactionDialog transactionId={item._id}><Button  variant={"outline"} className="text-orange-600 h-5  border-orange-500 hover:text-orange-600">Edit</Button></EditTransactionDialog>
